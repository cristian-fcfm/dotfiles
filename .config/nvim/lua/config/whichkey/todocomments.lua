...
wk.add({
  ...
  { ']f', function() require('todo-comments').jump_next({ keywords = { "FIX", "FIXME", "BUG" } }) end, desc = 'Next FIXME' },
  { '[f', function() require('todo-comments').jump_prev({ keywords = { "FIX", "FIXME", "BUG" } }) end, desc = 'Previous FIXME' },
})
