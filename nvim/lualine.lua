vim.schedule(function()
  ...
  require("lualine").setup({
    ...
    sections = {
      ...
      lualine_b = {
        {
          function() return vim.b.gitsigns_head or "" end,
          icon = "󰊢",
      ...
      lualine_c = {
        { "filetype", icon_only = true, separator = { left = "", right = "" }, padding = { left = 1, right = 0 } },
        { "filename", symbols = { readonly = "󰈡", modified = "" }, padding = { left = 0, right = 1 } },
        "searchcount",
        { symbols.get, cond = symbols.has },
      },
      lualine_x = {
        { "lsp_status", icon = "󰒋", symbols = { separator = "   ", done = "", spinner = "" } },
